...
#endif
	void (*throughput_static_init)(void);
	void (*throughput_static_deinit)(void);
};
...
#endif
static inline void sprd_throughput_static_init(struct sprd_priv *priv)
{
	if (priv->chip.ops->throughput_static_init)
		return priv->chip.ops->throughput_static_init();
}

static inline void sprd_throughput_static_deinit(struct sprd_priv *priv)
{
	if (priv->chip.ops->throughput_static_deinit)
		return priv->chip.ops->throughput_static_deinit();
}
