...
/* The flag is used to determine where is calling sprdwl_chr_deinit*/
 ...
 * @thread_completed: use with the "sprdwl_chr_deinit"
 * @socket_completed: use with the "sprdwl_chr_deinit"
 * @priv: struct priv
 * @hif: struct hif
...
void sprdwl_chr_report_open_error(struct sprdwl_chr *chr, u32 evt_id,
				u8 err_code);
