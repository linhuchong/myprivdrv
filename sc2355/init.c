...
void sc2355_throughput_static_init(void)
{
...
void sc2355_throughput_static_deinit(void)
{
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0))
...
#endif
	.throughput_static_init = sc2355_throughput_static_init,
	.throughput_static_deinit = sc2355_throughput_static_deinit,
};
